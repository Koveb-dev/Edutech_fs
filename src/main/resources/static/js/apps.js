            ...
            libros.forEach(libro => {
                const fila = `
                    <tr>
                        ...
                        <td> 
                            <button class="btn btn-danger btn-sm" onclick="eliminarLibro(${libro.id})">🗑️ Eliminar</button> // Botón para eliminar el libro con class de Bootstrap
                            <button class="btn btn-warning btn-sm" onclick="buscarLibro(${libro.id})">✏️ Editar</button> // Botón para editar el libro con class de Bootstrap
